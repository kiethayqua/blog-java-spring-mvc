	...
	<div class="container">
		<div class="row gutter-v1 align-items-stretch">
			...
			<div class="col-md-9 pr-md-5">
				<div class="row mb-5">
					<%
						List<Post> postList = (List<Post>) request.getAttribute("today_posts");
...
<div class="section-more-posts">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<h2 class="section-title text-center">${category_posts[0].category }</h2>
				<c:set var="count" value="0" scope="page" />
				<c:forEach var="p" items="${category_posts[0].posts }">
					<c:if test = "${count < 3 }">
					<div class="post-entry horizontal d-flex mb-0">
						<div class="media">
							<a href="/DoAnCuoiKy/post/${p.id }.htm"><img src="/DoAnCuoiKy/${p.image }" alt="Image"
								class="img-fluid"></a>
						</div>
						<div class="text">
							<div class="meta-cat">
			...
			<div class="col-md-6">
				<h2 class="section-title text-center">${category_posts[1].category }</h2>
				<c:set var="count" value="0" scope="page" />
				<c:forEach var="p" items="${category_posts[1].posts}">
				<c:if test = "${count < 3 }">
					<div class="post-entry horizontal d-flex mb-0">
						<div class="media">
							<a href="/DoAnCuoiKy/post/${p.id }.htm"><img src="/DoAnCuoiKy/${p.image }" alt="Image"
	...
	<div class="container">
		<div class="row gutter-v1">
			<div class="col-12 text-center">
				<h2 class="section-title text-center">${category_posts[2].category }</h2>
			</div>
			<c:set var="count" value="0" scope="page" />
			<c:forEach var="p" items="${category_posts[2].posts}">
			<c:if test = "${count < 4 }">
